...
source("scripts/Functions.R") ## Script file with functions for model-fitting and plotting ##
source("scripts/Functions_plotting.R") ## Additional functions used in this script only ##
...
class.densities[, "Density",] <- class.densities[, "Density",] * 4.04686267 # Convert to per 1000 acres
...
#__________________________________ PLOTTING (GIS tool manual version) ___________________________________#
